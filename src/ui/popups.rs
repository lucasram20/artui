...
/// `apply_patch`, command for `shell`, JSON for unknown) and a footer
/// with the keybindings.
fn draw_approval(frame: &mut Frame<'_>, app: &App) {
    ...
    // Truncate body lines so a 1000-line diff doesn't blow the popup.

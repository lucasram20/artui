...
- [[_COMMUNITY_TUI Chat Rendering & Layout|TUI Chat Rendering & Layout]]
- [[_COMMUNITY_Cloudflare Worker & Release Tooling|Cloudflare Worker & Release Tooling]]
- [[_COMMUNITY_apply_patch & Copilot Integration Tests|apply_patch & Copilot Integration Tests]]
- [[_COMMUNITY_App State & SlashMention Matching|App State & Slash/Mention Matching]]
- [[_COMMUNITY_LSP Client|LSP Client]]
- [[_COMMUNITY_System Prompt Construction|System Prompt Construction]]
- [[_COMMUNITY_Config Schema & Providers Config|Config Schema & Providers Config]]
- [[_COMMUNITY_OpenAI OAuth Login|OpenAI OAuth Login]]
- [[_COMMUNITY_Copilot RequestResponse Mapping|Copilot Request/Response Mapping]]
- [[_COMMUNITY_LSP Tool Execution & Tests|LSP Tool Execution & Tests]]
- [[_COMMUNITY_MCP Client|MCP Client]]
- [[_COMMUNITY_Auth Store|Auth Store]]
- [[_COMMUNITY_NPM Package Manifest|NPM Package Manifest]]
- [[_COMMUNITY_App ProviderModel Discovery|App Provider/Model Discovery]]
- [[_COMMUNITY_Model Picker & Slash Commands|Model Picker & Slash Commands]]
- [[_COMMUNITY_Skill Registry|Skill Registry]]
- [[_COMMUNITY_CLI Entrypoint & Arg Parsing|CLI Entrypoint & Arg Parsing]]
- [[_COMMUNITY_Session Store (SQLite)|Session Store (SQLite)]]
- [[_COMMUNITY_LSP Server Registry|LSP Server Registry]]
- [[_COMMUNITY_LSP Phase Specs|LSP Phase Specs]]
- [[_COMMUNITY_LSP Manager|LSP Manager]]
- [[_COMMUNITY_Credential Env Keys|Credential Env Keys]]
- [[_COMMUNITY_Agent Turn Loop|Agent Turn Loop]]
- [[_COMMUNITY_TUI Popups & Pickers|TUI Popups & Pickers]]
- [[_COMMUNITY_GitHub Device Login|GitHub Device Login]]
- [[_COMMUNITY_NPM Package (art)|NPM Package (art)]]
- [[_COMMUNITY_Permissions Engine|Permissions Engine]]
- [[_COMMUNITY_LSP Workspace Edits|LSP Workspace Edits]]
- [[_COMMUNITY_Cloudflare tsconfig|Cloudflare tsconfig]]
- [[_COMMUNITY_NPM Install Script|NPM Install Script]]
- [[_COMMUNITY_tsconfig (npm)|tsconfig (npm)]]
- [[_COMMUNITY_App ModelContext Accessors|App Model/Context Accessors]]
- [[_COMMUNITY_Ollama Provider|Ollama Provider]]
- [[_COMMUNITY_Tool Registry|Tool Registry]]
- [[_COMMUNITY_Shell Tool|Shell Tool]]
- [[_COMMUNITY_Todo Write Tool|Todo Write Tool]]
- [[_COMMUNITY_Update Check & Semver|Update Check & Semver]]
- [[_COMMUNITY_Cloudflare Worker Package|Cloudflare Worker Package]]
- [[_COMMUNITY_Hooks System|Hooks System]]
- [[_COMMUNITY_Copilot Provider Streaming|Copilot Provider Streaming]]
- [[_COMMUNITY_Tool Spec Serialization|Tool Spec Serialization]]
- [[_COMMUNITY_Provider Trait & Builder|Provider Trait & Builder]]
- [[_COMMUNITY_Architecture Specs & Design Docs|Architecture Specs & Design Docs]]
- [[_COMMUNITY_NPM Install UI (Ink)|NPM Install UI (Ink)]]
- [[_COMMUNITY_Context Compaction|Context Compaction]]
- [[_COMMUNITY_Account Provider (Codex)|Account Provider (Codex)]]
- [[_COMMUNITY_Account SSE Parsing|Account SSE Parsing]]
- [[_COMMUNITY_OpenAI-compat Streaming|OpenAI-compat Streaming]]
- [[_COMMUNITY_UI Status Line & Theme|UI Status Line & Theme]]
...
- **R2-first install source resolution** — install_sh, install_ps1, install_npm_resolve_asset_url, distribution_install_fallback_order [INFERRED 0.85]
- **Helix LSP registry generation pipeline** — sync_helix_lsp_index_languages, sync_helix_lsp_build_server_entries, sync_helix_lsp_emit_toml, sync_helix_lsp_defaults_toml [EXTRACTED 1.00]
- **Tool execution pipeline (events → registry → loop → permissions)** — todos_phase_a_tool_events_phase_a, todos_phase_b_tool_registry_phase_b, todos_phase_c_session_and_loop_phase_c, todos_phase_d_glob_search_permission_engine [INFERRED 0.85]
- **Permission Ask modal flow across phases** — todos_phase_e_apply_patch_ask_flow, todos_phase_m1_diff_preview_popup_phase_m1, todos_phase_m2_permission_ask_ui_phase_m2, todos_phase_d_glob_search_permission_engine [INFERRED 0.75]
- **Write-tool safety net (apply_patch, sandbox, snapshots)** — todos_phase_e_apply_patch_rollback_metadata, todos_phase_j_bwrap_sandbox_phase_j, todos_phase_m3_snapshots_rollback_phase_m3 [INFERRED 0.75]
- **LSP rollout phases N1-N4** — todos_phase_n1_lsp_skeleton, todos_phase_n2_lsp_readonly_ops, todos_phase_n3_lsp_writethrough, todos_phase_n4_lsp_mutating_ops [EXTRACTED 1.00]
- **LSP core module trio** — todos_phase_n1_lsp_client, todos_phase_n1_lsp_manager, todos_phase_n1_server_registry [EXTRACTED 1.00]
- **Writethrough diagnostics feedback flow** — todos_phase_n3_apply_patch, todos_phase_n3_writethrough_module, todos_phase_n2_diagnostics_cache, todos_phase_n3_feedback_loop [EXTRACTED 1.00]
- **Tool trait implementors** — tools_apply_patch_applypatchtool, tools_glob_globtool, tools_lsp_lsptool, tools_read_file_readfiletool, tools_search_searchtool, tools_shell_shelltool, tools_todo_write_todowritetool [EXTRACTED 1.00]
- **apply_patch writethrough diagnostics flow** — tools_apply_patch_applypatchtool, lsp_writethrough_after_edit, lsp_writethrough_track_and_collect, lsp_client_track, lsp_client_cached_diagnostics, lsp_render_filter_diagnostics_to_changed_region [EXTRACTED 1.00]
- **lsp tool request/response flow** — tools_lsp_lsptool, lsp_manager_for_path, lsp_client_lspclient, lsp_render_locations_from_response, lsp_edits_apply_workspace_edit [EXTRACTED 1.00]
- **LlmProvider trait implementors** — providers_openai_compat_openaicompatprovider, providers_account_accountprovider, providers_copilot_copilotprovider, ollama_ollamaprovider, providers_freemodel_freemodelprovider, concept_provider_trait [EXTRACTED 1.00]
...
- `Per-branch token budget` → `patch-see-breakage-fix feedback loop`  [AMBIGUOUS]
